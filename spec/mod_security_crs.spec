...
for f in `ls %{buildroot}%{_datarootdir}/mod_modsecurity_crs/plugins/*-before.conf` ; do
    ln -s %{buildroot}%{_datarootdir}/mod_modsecurity_crs/plugins/$f %{buildroot}%{_sysconfdir}/httpd/modsecurity.d/plugins/$f;
done
...
for f in `ls %{buildroot}%{_datarootdir}/mod_modsecurity_crs/plugins/*-config.conf` ; do
    ln -s %{buildroot}%{_datarootdir}/mod_modsecurity_crs/plugins/$f %{buildroot}%{_sysconfdir}/httpd/modsecurity.d/plugins-config/$f;
done
